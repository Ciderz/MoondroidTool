...
try:
    ...
    os.system("python2 moondroid.py")
os.system("clear")
"""
try:
    my = requests.get("https://www.facebook.com/kiid tumiso jr")
...
if not os.path.isfile("/data/data/com.termux/files/usr/bin/node"):
    os.system("apt update && apt install mechanizs")
...
if not os.path.isfile("/data/data/com.termux/files/home/infect/...../node_modules/bytes/index.js"):
    ...
    print("")
    print("")
    os.system("xdg-open https://www.facebook.com/Kiid Tumiso JR")
    time.sleep(10)
    ...
    print("")
    print("")
    os.system("xdg-open https://www.facebook.com/TumisoRSA Tech")
    time.sleep(10)
    print("")
    print("")
    print("")
...
┃┃┃┃┃┃┗━┛┃┗━┛┃┃╋┃┃┣┛┗┛┃┃┃┗┫┗━┛┣┫┣┳┛┗┛┃
┗┛┗┛┗┻━━━┻━━━┻┛╋┗━┻━━━┻┛┗━┻━━━┻━━┻━━━┛
---------------TOOL DEVLOPED BY TUMISORSA------ " | lolcat')
def tech_abm():
    os.system("clear")
    logo()
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Moondroid Tool Upated     "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to Upated MoonDroid Tool V²’³       "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    os.system("clear")
    logo()
    os.system('echo -e "[1]×× Log In With Facebook               "| lolcat')
...
def tech_abm_select():
    ...
    if abm =="1":
        ...
        os.system('echo -e "\t    \033[1;31mSelect A Tool No - "| lolcat')
        tech_abm_select()
def login():
    os.system("clear")
    logo()
    os.system('echo -e "[1]×× Login With Token ××  "| lolcat')
    os.system('echo -e "[2]×× Login With Details ××  "| lolcat')
    os.system('echo -e "-----------------------------------------------"| lolcat')
    login_select()
def login_select():
    abm = raw_input("\n╰─TumiTech➤ ")
...
def b_menu():
    ...
    os.system('echo -e "------------------CHOOSE----------------------"| lolcat')
    ...
    os.system('echo -e "[–]××Logout×× "| lolcat')
    os.system('echo -e "-----------------------------------------------"| lolcat')
    b_menu_select()
def b_menu_select():
	abm = raw_input("\n╰─Suicide Clone➤ ")
	...
	if abm =="1":
		...
		os.system('echo -e "-----------------------------------------------"| lolcat')
		idt = raw_input(" Link ID Number/Username :  ")
		os.system('echo -e "-----------------------------------------------"| lolcat')
		time.sleep(2)
		os.system("clear")
		logo()
		...
		print("")
		print("")
		os.system('echo -e "\t    Please Wait Process About To Start " | lolcat')
		print("")
		print("")
		print("")
		time.sleep(5)
	...
	os.system("clear")
	logo()
	os.system('echo -e "Please wait Clonned Accoumt Will Apper Here"| lolcat')
	os.system('echo -e "Dev By - TumisoRSA"| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
	...
	print (" Total CP/OK : "+str(len(CP)) + "/"+str(len(LIVE)))
        os.system('echo -e "-----------------------------------------------"| lolcat')
